    ...
    public partial class TaskPage : Form
    {
        ...
        public void fill_grid()
        {
            ...
            {             
                ...
                taskGrid.Columns["X"].DisplayIndex = 0;
                checkCheckmark();
                taskGrid.Columns.RemoveAt(2);
            }
            catch (Exception)
            {
                this.Close();
        ...
        {
            DialogResult dialogResult = MessageBox.Show("Are you sure you want to save these changes?", "Are you sure?", MessageBoxButtons.YesNo);
            if (dialogResult == DialogResult.Yes)
            {
                ...
                for (int i = 0; i < taskGrid.Rows.Count; i++)
                {
                    ...
                    if (cell != null && Convert.ToBoolean(cell.Value) == true)
                    {
                        ...
                        //DialogResult dialogResult = MessageBox.Show($@" CheckBox is {done}", $@"Are you sure", MessageBoxButtons.YesNo);
        ...
        {          
            for (int i = 0; i <  taskGrid.Rows.Count; i++)
            {
                ...
                {
                    cell.Value = Convert.ToBoolean(cell.TrueValue); 
                }
            }            
        }
    }
